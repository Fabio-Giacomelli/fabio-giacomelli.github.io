...
function hfun_m1fill(vname)
  var = vname[1]
  return pagevar("publicatoins", var)
end
```

Which you can use like this `{{m1fill title}}`: **{{m1fill title}}**. Of course  in this specific case you could also have used `{{fill title publications}}`: **{{fill title publications}}**.
